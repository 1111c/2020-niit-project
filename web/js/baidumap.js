    ...
    function createMap(){
        ...
        var point = new BMap.Point(117.271429,37.135336);//瀹氫箟涓€涓腑蹇冪偣鍧愭爣
        map.centerAndZoom(point,12);//璁惧畾鍦板浘鐨勪腑蹇冪偣鍜屽潗鏍囧苟灏嗗湴鍥炬樉绀哄湪鍦板浘瀹瑰櫒涓?
    ...
    function setMapEvent(){
        ...
        map.disableKeyboard();//绂佺敤閿洏涓婁笅宸﹀彸閿Щ鍔ㄥ湴鍥撅紝榛樿绂佺敤(鍙笉鍐?
    }
    ...
    //鏍囨敞鐐规暟缁?
    var markerArr = [{title:"骞垮窞",content:"鎴戠殑澶囨敞",point:"113.270567|23.139058",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
         ];
    //鍒涘缓marker
    function addMarker(){
