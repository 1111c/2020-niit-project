    ...
    <div class="layui-col-md6">
      <div class="layui-card">
          <div class="layui-card-body">
              <div style="float: left;"><img src="resources/image/SH/1.jpg" style="width: 80px; height: 80px;" alt=""/></div>
        ...
        <div class="layui-card-body">
            <h2 style="color:#2F4056"><b>春和景明一期 2室1厅 146万</b></h2>
            <a>更多房源信息请联系经纪人</a>
        </div>
      </div>
    </div>
        ...
        <div class="layui-container" style="margin-top: 50px; ">
              <div class="layui-row layui-col-space30">
                      ...
                      <div class="grid-demo grid-demo-bg1">
                          <div class="layui-row">
                              <div class="layui-carousel" id="test1">
                                  <div carousel-item>
                                      <div style=" text-align: center;"><img src="resources/image/ShowHouse_1/1.jpg" style="width:600px;height: 330px;"></div>
                                      <div style=" text-align: center;"><img src="resources/image/ShowHouse_1/2.jpg" style="width:600px;height: 330px;"></div>
                                      <div style=" text-align: center;"><img src="resources/image/ShowHouse_1/3.jpg" style="width:600px;height: 330px;"></div>
                                      <div style=" text-align: center;"><img src="resources/image/ShowHouse_1/4.jpg" style="width:600px;height: 330px;"></div>
                                      <div style=" text-align: center;"><img src="resources/image/ShowHouse_1/5.jpg" style="width:600px;height: 330px;"></div>
                                  </div>
                              </div>  
                          </div>
                      </div>
                  ...
                  <div class="layui-col-md5">
                      <div class="grid-demo">
                          <a style="font-size: 35px; font-weight: 2px; color: #FF5722">146</a>
                          ...
                          <div style="margin-top: 25px;">
                              ...
                              <div style="float: left">
                                  <a style="font-size: 25px;font-weight: 3px;margin-left: 80px;">77.26平米</a>
                              </div>
                              <div style="clear: both"></div>
                          </div>
                          <hr style="margin-top: 25px;">
                        ...
                        <table class="layui-table" lay-skin="nob" style="margin-top: 20px;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>所在楼层</td>
                                    <td style="color:black">10层</td>
                                </tr> 
                                <tr>
                                    <td></td>
                                    <td>建筑面积</td>
                                    <td style="color:black">77.26</td>
                                    <td>户型结构</td>
