    ...
    <div class="layui-col-md6">
      <div class="layui-card">
          <div class="layui-card-body">
              <div style="float: left;"><img src="resources/image/SH/2.jpg" style="width: 80px; height: 80px;" alt=""/></div>
        ...
        <div class="layui-card-body">
            <h2 style="color:#2F4056"><b>百通馨苑七区</b></h2>
            <a>此房满五唯一！南北通透，业主诚售！</a>
        </div>
      </div>
    </div>
    <div class="layui-col-md6">
        ...
        <div class="layui-container" style="margin-top: 50px; ">
              <div class="layui-row layui-col-space30">
                      ...
                      <div class="grid-demo grid-demo-bg1">
                          <div class="layui-row">
                              <div class="layui-carousel" id="test1">
                                  <div carousel-item>
                                      <div style=" text-align: center;"><img src="resources/image/ShowHouse_2/1.jpg" style="width:600px;height: 330px;"></div>
                                      <div style=" text-align: center;"><img src="resources/image/ShowHouse_2/2.jpg" style="width:600px;height: 330px;"></div>
                                      <div style=" text-align: center;"><img src="resources/image/ShowHouse_2/3.jpg" style="width:600px;height: 330px;"></div>
                                      <div style=" text-align: center;"><img src="resources/image/ShowHouse_2/4.jpg" style="width:600px;height: 330px;"></div>
                                      <div style=" text-align: center;"><img src="resources/image/ShowHouse_2/5.jpg" style="width:600px;height: 330px;"></div>
                                  </div>
                              </div>  
                          </div>
                      </div>
                  ...
                  <div class="layui-col-md5">
                      <div class="grid-demo">
                          <a style="font-size: 35px; font-weight: 2px; color: #FF5722">166</a>
                          <a style="font-size: 15px;color: #FF5722">万</a>
                          <hr style="margin-top: 25px;">
                          <div style="margin-top: 25px;">
                              <div style="float: left">
                                  <a style="font-size: 25px;font-weight: 3px;">两室一厅</a>
                              </div>
                              <div style="float:left">
                                  <a style="font-size: 25px;font-weight: 3px; margin-left: 80px; ">朝南</a>
                              </div>
                              <div style="float: left">
                                  <a style="font-size: 25px;font-weight: 3px;margin-left: 80px;">85.44平米</a>
                              </div>
                              <div style="clear: both"></div>
                          </div>
                          <hr style="margin-top: 25px;">
                    ...
                    <div class="grid-demo grid-demo-bg1">
                        ...
                        <table class="layui-table" lay-skin="nob" style="margin-top: 20px;">
                            ...
                            <tbody>
                                <tr>
                                    <td>基本属性</td>
                                    <td>房屋户型</td>
                                    <td style="color:black">两室一厅</td>
                                    <td>所在楼层</td>
                                    <td style="color:black">高层</td>
                                </tr> 
                                <tr>
                                    <td></td>
                                    <td>建筑面积</td>
                                    <td style="color:black">85.44</td>
                                    <td>户型结构</td>
                        ...
                        <table class="layui-table" lay-skin="nob" style="margin-top: 20px;">
                            ...
                            <tbody>
                                <tr>
                                    <td>户型介绍</td>
                                    <td style="color:black">两室一厅一厨一卫</td>
                                </tr> 
                            </tbody>
                        </table> 
                        <hr style="margin-top: 20px;">
