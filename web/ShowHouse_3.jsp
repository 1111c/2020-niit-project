  ...
  <div class="layui-row layui-col-space15">
    <div class="layui-col-md6">
      <div class="layui-card">
        ...
        <div class="layui-card-body">
            <h2 style="color:#2F4056"><b>帝都嘉园</b></h2>
            <a>此房满两年，精装修，总价低，楼层好，全天采光充足。</a>
        </div>
      </div>
    </div>
    <div class="layui-col-md6">
        ...
        <div class="layui-container" style="margin-top: 50px; ">
              <div class="layui-row layui-col-space30">
                      ...
                      <div class="grid-demo grid-demo-bg1">
                          <div class="layui-row">
                              <div class="layui-carousel" id="test1">
                                  <div carousel-item>
                                      <div style=" text-align: center;"><img src="resources/image/ShowHouse_3/1.jpg" style="width:600px;height: 330px;"></div>
                                      <div style=" text-align: center;"><img src="resources/image/ShowHouse_3/2.jpg" style="width:600px;height: 330px;"></div>
                                      <div style=" text-align: center;"><img src="resources/image/ShowHouse_3/3.jpg" style="width:600px;height: 330px;"></div>
                                      <div style=" text-align: center;"><img src="resources/image/ShowHouse_3/4.jpg" style="width:600px;height: 330px;"></div>
                                      <div style=" text-align: center;"><img src="resources/image/ShowHouse_3/5.jpg" style="width:600px;height: 330px;"></div>
                                  </div>
                              </div>  
                          </div>
                      </div>
                  ...
                  <div class="layui-col-md5">
                      <div class="grid-demo">
                          <a style="font-size: 35px; font-weight: 2px; color: #FF5722">104</a>
                          <a style="font-size: 15px;color: #FF5722">万</a>
                          <hr style="margin-top: 25px;">
                          <div style="margin-top: 25px;">
                              <div style="float: left">
                                  <a style="font-size: 25px;font-weight: 3px;">一室两厅</a>
                              </div>
                              <div style="float:left">
                                  <a style="font-size: 25px;font-weight: 3px; margin-left: 80px; ">朝南</a>
                              </div>
                              <div style="float: left">
                                  <a style="font-size: 25px;font-weight: 3px;margin-left: 80px;">75.93平米</a>
                              </div>
                              <div style="clear: both"></div>
                          </div>
                          <hr style="margin-top: 25px;">
                    ...
                    <div class="grid-demo grid-demo-bg1">
                        ...
                        <table class="layui-table" lay-skin="nob" style="margin-top: 20px;">
                            ...
                            <tbody>
                                <tr>
                                    <td>基本属性</td>
                                    <td>房屋户型</td>
                                    <td style="color:black">一室两厅</td>
                                    <td>所在楼层</td>
                                    <td style="color:black">15层</td>
                                </tr> 
                                <tr>
                                    <td></td>
                                    <td>建筑面积</td>
                                    <td style="color:black">75.39</td>
                                    <td>户型结构</td>
                        ...
                        <table class="layui-table" lay-skin="nob" style="margin-top: 20px;">
                            ...
                            <tbody>
                                <tr>
                                    <td>户型介绍</td>
                                    <td style="color:black">一室两厅一厨一卫</td>
                                </tr> 
                            </tbody>
                        </table> 
                        <hr style="margin-top: 20px;">
